 ...
 *          description: Error de validacion.
 */
router.get('/:id', customHeader, validatorGetItem, getItem);
 ...
 */
router.post('/', uploadMiddleware.single("myFile"), customHeader, createItem);
 ...
 *          description: Error de validacion.
 */
router.delete('/:id', customHeader, validatorGetItem, deleteItem);
